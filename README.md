...
2. *Content vs. Function Words:* By the final layer, content words, and especially those that rely on surrounding words for disambiguation, deviate significantly from their original embeddings, conceptually drifting far from their initial representations. In contrast, function words, like "and" or "the," remain much closer to their original embeddings, indicating that the attention mechanism doesn't significantly alter their rankings.
